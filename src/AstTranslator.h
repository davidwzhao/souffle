...
private:
    ...
    std::unique_ptr<RamRelationReference> translateNewDiffRelation(const AstRelation* rel);
    std::unique_ptr<RamRelationReference> translateDeltaDiffRelation(const AstRelation* rel);
