...
private:
    ...
    std::unique_ptr<RamRelationReference> translateUpdatedMinusRelation(const AstRelation* rel);
    std::unique_ptr<RamRelationReference> translateUpdatedPlusRelation(const AstRelation* rel);
